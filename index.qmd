...
::: {.aoa-hero}
![](gallery/aoa-logo-home.webp){.aoa-hero-logo fig-alt="The Architecture of Apostasy brand image, carrying the site's title treatment."}

## A path to be kept. A keeping under Christ. A measure not our own.

A Christian theological library examining how good gifts, practices, and institutions become idols, and how they are returned to Christ.
...
The Troth is the fidelity of God disclosed and enacted in Jesus Christ: the faithfulness that remains when keepers fail, institutions fail, and vows fail, and return still remains possible.
...
<p class="pillar-map-text">The diagram shows a continuous cycle, not three separate stops: The Path diagnoses what spirit has taken flesh, The Keeping holds that diagnosis in faithful, embodied response, and The Measure returns the keeper to Christ rather than to self-justification &mdash; before the cycle begins again.</p>
:::
