...
## Catholic, Orthodox, Protestant, And Anabaptist Readers
...
Start with [Method](method.qmd), then read the essays with the distinction between doctrine, exegesis, analogy, historical judgment, and prophetic warning in mind.
...
Read [Method](method.qmd) first. Then use the public essays as arguments to test, not slogans to consume.
