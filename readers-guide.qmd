...
This site is for readers who want to discern how apostasy takes flesh, how faithful keeping is embodied, and how Christ remains the measure of every keeper, office, and act of protection.

It is also for readers who may not share every premise of the project but are willing to test its claims carefully.

## What Not To Do With The Library

Do not consume the library as aesthetic doom, theological superiority, or anti-institutional confirmation bias.
...
Start with [Method](method.qmd), then read [Rival Readings](rival-readings.qmd).
...
Start with [The Path of Re-Embodiment](path.qmd), then [Core Concepts](core-concepts.qmd).
...
Start with [The Keeping of the Troth](keeping.qmd), then [The Measure of Christ](measure.qmd).
...
Start with [The Measure of Christ](measure.qmd), [Method](method.qmd), and [Rival Readings](rival-readings.qmd), then read the essays with the distinction between doctrine, exegesis, analogy, historical judgment, and prophetic warning in mind.
...
Read [The Measure of Christ](measure.qmd), [Method](method.qmd), and [Rival Readings](rival-readings.qmd) first. Then use the public essays as arguments to test, not slogans to consume.
...
The goal is not to master the architecture from outside. The goal is to keep the path of return in truth, under Christ as the measure.
