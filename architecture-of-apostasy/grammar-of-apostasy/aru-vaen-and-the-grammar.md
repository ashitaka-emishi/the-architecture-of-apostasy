...
- a substitute for Scripture, doctrine, evidence, or human review;
- a private mythology treated as binding revelation;
- a way to smuggle undefined terms into canonical chapters.

Do not flatten wolves, sheep, the Shepherd, the Black Sun, offices, names, or places into fixed entries in the canonical glossary. They may illuminate posture and symbolic imagination, but they should not be treated as required technical equivalents for Grammar terms.

## Safe Uses In Canonical Work
...
- Devotional use: it calls the reader toward faithful keeping.
- Comparative use: it is compared with a Grammar term while preserving distinction.

Avoid ontological use unless a future amendment explicitly defines a term and provides a migration note.
